...
class Handler implements ExceptionHandlerContract
{
    ...
    /**
     * Converta uma exceção de autenticação em uma resposta.
     * Eu alterei a logica desse código.
     * @param  \Illuminate\Http\Request  $request
    ...
    {
        /* Estamos fazendo uma verificação na config/auth.php, para saber se está logado em user ou admin */
